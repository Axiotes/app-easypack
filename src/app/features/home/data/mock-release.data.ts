...
export const mockClients: Client[] = [
  { id: 1, nm_cliente: 'Grupo Vitalis', id_setor_atendimento: 1, setor_atendimento: 'ST', status_ambiente: 'PRD', cidade: 'São Paulo', uf: 'SP' },
  { id: 2, nm_cliente: 'Clínica Horizonte', id_setor_atendimento: 1, setor_atendimento: 'ST', status_ambiente: 'PRE-PROD', cidade: 'Rio de Janeiro', uf: 'RJ' },
  { id: 3, nm_cliente: 'Hospital Nova Aurora', id_setor_atendimento: 2, setor_atendimento: 'FB', status_ambiente: 'PRD', cidade: 'Belo Horizonte', uf: 'MG' },
  { id: 4, nm_cliente: 'Centro Médico Prisma', id_setor_atendimento: 1, setor_atendimento: 'ST', status_ambiente: 'PRD', cidade: 'Belo Horizonte', uf: 'MG' },
  { id: 5, nm_cliente: 'Instituto Vida Plena', id_setor_atendimento: 2, setor_atendimento: 'FB', status_ambiente: 'PRE-PROD', cidade: 'Belo Horizonte', uf: 'MG' },
  { id: 6, nm_cliente: 'Rede Bem Estar', id_setor_atendimento: 1, setor_atendimento: 'ST', status_ambiente: 'PRD', cidade: 'São Paulo', uf: 'SP' },
  { id: 7, nm_cliente: 'Hospital Vale Sereno', id_setor_atendimento: 2, setor_atendimento: 'FB', status_ambiente: 'PRE-PROD', cidade: 'Porto Alegre', uf: 'RS' }
];
